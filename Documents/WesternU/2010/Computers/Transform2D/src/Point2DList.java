...
public class Point2DList {
  ...
  /**
   * Modifier method applies the Transform2D matrix supplied by the parameter to each of the Point2D objects maintained in the ArrayList. The 
  ...
  public void applyTransform(Transform2D transform) {
    ...
    pts = transform.getTransform2D().mul(pts).getElements();
    for (int i = 0; i < points.size(); i++) {
